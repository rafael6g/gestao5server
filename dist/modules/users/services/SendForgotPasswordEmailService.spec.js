...
describe('SendForgotPasswordEmail', function () {
    ...
    it('should be able to recover the password using email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
    ...
    it('should not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should generate a forgot password token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    generate = jest.spyOn(fakeUserTokensRepository, 'generate');
                    return [4 /*yield*/, fakeUsersRepository.create({
                            name: 'John Doe',
                            email: 'johndoe@example.com',
                            password: '123456',
